...
def case_file_remember(note: str, tool_context: ToolContext) -> dict:
    ...
    Use it to jot a durable fact for later turns (e.g. "identity verified",
    "cheapest = Green Fee-Free Account, $0 total"). Scoped to this conversation
    only; optional — never a substitute for the actual tools.
    """
    try:
